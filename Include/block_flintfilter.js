class flintfilter extends activeblock {
  ...
  drawpanel() {
    ...
    $("#gamepanel").append('<span id="sidepanel_flintshovel" class="sidepanelbutton" sytle="background-color:'+ this.choosetoolcolor(this.targetshovel, 'flintshovel') +'" title="'+ this.choosetoolpopup(this.targetshovel, 'flintshovel') +'" onclick="selectedblock.pickshovel(\'flintshovel\')">flintshovel</span>');
  }

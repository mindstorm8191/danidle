class garbage extends activeblock {
    ...
    update() {
        ...
        if(this.onhand==null) {
            // Not currently holding anything.  Search nearby for something to pick up
        ...
        if(workpoints<1) {
            // Not enough workers to destroy the target item
            return;
        }
    ...
    updatepanel() {
        ...
        // We don't currently have any work to do here, but it will get called automatically anyway, so it must exist
    }
